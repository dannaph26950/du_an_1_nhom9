    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($listall_khoahoc as $key=>$value) {?>
            <tr>
                ...
                <td class=""><input value="Sửa " type="button" class="btn btn-primary start-50" onclick="location.href='index.php?act=upd_khoahoc&id=<?php echo $value['id_khoa_hoc'] ?>'" ><br><br>
