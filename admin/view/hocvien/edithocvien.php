<?php
    ...
    foreach ($listone_hocvien as $key => $value) {
        ...
        <form method="post" action="index.php?act=upd_hocvien"  enctype="multipart/form-data">
            <div style="margin: 0px 300px;">
                ...
                <center>
                    <div style="text-align: center">
                        ...
                        <input type="submit" value="Cập Nhật" name="update_hv" class="btn btn-primary" style="width: 200px; margin: 0px 20px">
                        <a href="index.php?act=list_hocvien" ><input class="btn btn-primary" type="button" value="DANH SÁCH" style="width: 200px;margin: 0px 20px" ></a>
