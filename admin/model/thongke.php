...
//    $sql.= " GROUP BY danh_muc.id_danh_muc ORDER BY danh_muc.id_danh_muc DESC";
    $sql= "select danh_muc.id_danh_muc as id_danh_muc ,danh_muc.ten_danh_muc as ten_danh_muc, dang_ky.gia_tien AS gia_tien , count(khoa_hoc.id_khoa_hoc) as countsp, min(dang_ky.gia_tien) as mingia, max(dang_ky.gia_tien) as maxgia,avg(dang_ky.gia_tien) as avggia, dang_ky.ngay_dk as ngay";
