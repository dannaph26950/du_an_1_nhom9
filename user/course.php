...
<head>
    ...
    <title>Acadu - Online Courses & Education HTML Template - Course</title>
        ...
        <div class="as-sort-bar">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-auto">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Loại khóa học</label>
                ...
                <div class="col-md-auto">
                    <div class="nav" role="tablist"><a href="#" class="active" id="tab-course-grid"
                                                       data-bs-toggle="tab" data-bs-target="#tab-grid" role="tab"
                                                       aria-controls="tab-grid"
                                                       aria-selected="true"><i class="fa-solid fa-grid-2"></i> Lưới</a>
                        <a href="#"
                           id="tab-course-list" data-bs-toggle="tab" data-bs-target="#tab-list" role="tab"
                           aria-controls="tab-grid" aria-selected="false"><i class="fas fa-list"></i> Danh sách</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="tab-list" role="tabpanel" aria-labelledby="tab-course-list">
                <div class="course-list">
                    <div class="course-img"><img src="assets/img/course/course_6_1.jpg" alt="course"> <span
                            class="tag">Free</span></div>
                    <div class="course-content">
                        ...
                        <p class="course-text">Learn How To Build The Perfect Diet & Meal Plan For Improved Health,
                                               Better Weight Loss And More Health, Better Weight Loss And More Health,
                                               Better Weight
                                               Loss And More Health, Diet & Meal Plan For Improved Better Weight Loss
                                               And More</p>
                ...
                <div class="course-list">
                    <div class="course-img"><img src="assets/img/course/course_6_2.jpg" alt="course"> <span
                ...
                <div class="course-list">
                    <div class="course-img"><img src="assets/img/course/course_6_3.jpg" alt="course"> <span
                            class="tag">Free</span></div>
                    <div class="course-content">
                ...
                <div class="course-list">
                    <div class="course-img"><img src="assets/img/course/course_6_4.jpg" alt="course"> <span
                            class="tag">22.9$</span></div>
                    <div class="course-content">
                        <h3 class="course-title"><a href="course-details.html">How To Make Something Very Easier
                                                                               Than You Think</a></h3>
                ...
                <div class="course-list">
                    <div class="course-img"><img src="assets/img/course/course_6_5.jpg" alt="course"> <span
                            class="tag">Free</span></div>
                    <div class="course-content">
                        <h3 class="course-title"><a href="course-details.html">Try To Make Something Very Easier
                                                                               Than You Learn</a></h3>
